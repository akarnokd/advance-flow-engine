...
public class DestinationToCompositeOutputError implements AdvanceCompilationError, HasBinding {
	...
	/**
	 * Constructor.
	 * <p>The wire's destination is bound to an output port of a composite block (not the parent block)</p>
	 * @param binding the actual binding causing the problem
	 */
	public DestinationToCompositeOutputError(AdvanceBlockBind binding) {
		this.binding = binding;
	}
	/** Empty constructor. */
	public DestinationToCompositeOutputError() {
		
	}
	@Override
	public String toString() {
		return "Wire " + binding.id + " destination is bound to an output port of a composite block (" + binding.destinationBlock + ", " + binding.destinationParameter + ")";
	}
	@Override
	...
	public static final Func0<DestinationToCompositeOutputError> CREATOR = new Func0<DestinationToCompositeOutputError>() {
		@Override
		public DestinationToCompositeOutputError invoke() {
			return new DestinationToCompositeOutputError();
		}
	};
	/**
