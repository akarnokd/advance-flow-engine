 ...
 */
public class IncompatibleBaseTypesError implements AdvanceCompilationError, HasBinding, HasTypes {
	/** The wire identifier. */
	...
	/**
	 * Constructor.
	 * <p>The wire binds two parametric types which have incompatible base types or number of arguments.</p>
	...
	public String toString() {
		return "Incompatible base types of wire " + binding.id + ": " + left + " vs. " + right;
	}
	/** Empty constructor. */
	public IncompatibleBaseTypesError() {
	...
	public static final Func0<IncompatibleBaseTypesError> CREATOR = new Func0<IncompatibleBaseTypesError>() {
		@Override
		public IncompatibleBaseTypesError invoke() {
			return new IncompatibleBaseTypesError();
		}
	};
	/**
	...
	public static void register(Map<String, Func0<? extends AdvanceCompilationError>> map) {
		map.put(IncompatibleBaseTypesError.class.getSimpleName(), CREATOR);
	}
	@Override
	public AdvanceBlockBind binding() {
		return binding;
