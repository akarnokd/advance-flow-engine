 ...
 * Signature: LocalFileMove(trigger, localfiledatasource, string, string) -> boolean
 * @author szmarcell
 */
@Block(id = "___LocalFileMove", category = "file", scheduler = "IO", description = "Move/rename a local file")
public class LocalFileMove extends AdvanceBlock {
    /** The logger. */
    protected static final Logger LOGGER = Logger.getLogger(LocalFileMove .class.getName());
    /** In. */
    @Input("advance:real")
     ...
     */
    public LocalFileMove(AdvanceBlockSettings settings) {
        super(settings);
    }
    /** The running count. */
    private int count;
