 ...
 */
@Block(id = "DispatchOptions", category = "projection", 
scheduler = "NOW", 
description = "Takes a collection of values and emits each element as an option, followed by NONE.",
parameters = { "T" }
)
public class DispatchOptions extends AdvanceBlock {
    /** In. */
