...
/**
 * Computes the logical OR of all inputs.
 * @author karnokd, 2012.02.24.
 */
@Block(id = "Or", category = "projection", 
scheduler = "NOW", 
description = "Computes the logical OR of all inputs."
)
public class Or extends AdvanceBlock {
	/** 1. */
