...
/**
 * The combined operation of insert and update operations, e.g., tries to insert a new entry into the datastore or update an existing one.
...
public class JDBCReplace extends AdvanceBlock {
     ...
     */
    public JDBCReplace(AdvanceBlockSettings settings) {
        super(settings);
    }
    /** The running count. */
    private int count;
