...
public class LoginDialog extends javax.swing.JDialog implements ExplorerManager.Provider {
    ...
    /** */
	private static final long serialVersionUID = 7437253471263948567L;
    ...
    private Action createEditAction(int index) {
        ...
        return new AbstractAction("Edit...") {
            ...
            /** */
			private static final long serialVersionUID = -8462281917001761176L;
...
//                }
    ...
    private Action createClearAction(int index) {
        ...
        return new AbstractAction("Clear saved credentials...") {
            ...
            /** */
			private static final long serialVersionUID = 3511072539563371511L;
    ...
    private Action createDeleteAction(final int index) {
        return new AbstractAction("Delete...") {
            /** */
			private static final long serialVersionUID = 3003287104055924880L;
    ...
    private void doLogin(final LoginInfo info) {
        ...
        new SwingWorker<AdvanceEngineControl, Void>() {

            @Override
            protected AdvanceEngineControl doInBackground() throws Exception {
