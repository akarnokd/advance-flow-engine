...
(function($, window, document, undefined)
{
	var daybyPage = {
			...
			callDayByChart : function()
			{
				var mySelf = this;
				
				$("#" + mySelf.chartId).daybychart("clearBar");
				$("#" + mySelf.chartId).daybychart("daybyBar",{
					url : "api-daybyday.jsp",
					data : {
	...
	$.daybypage = function(method, param)
	{
		var op = Object.create(daybyPage);
