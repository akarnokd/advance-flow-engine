...
else
{
  try
  {
    ...
    hubDepotSwitch.setDuringOrient(request.getParameter("orient"));
    
    DuringDayData duringData = new DuringDayData(hubDepotSwitch);
    DateTime now = new DateTime(hubDepotSwitch.getDateTime());
	DuringDaySummary.createDuringData(duringData, now, hubDepotSwitch.hubId());
    result = DuringDayChart.getDuringDayJSON(duringData);
