...
{
    public class AdvanceJDBCDataSource : AdvanceCreateModifyInfo, IPassword, ICopiable<AdvanceJDBCDataSource>, IIdentifiable<string>
    {
        /// <summary>
        ...
        public AdvanceJDBCDataSource() : base() { }
        ...
        protected override void LoadFromXmlNode(XmlNode source)
        {
            ...
            this.Schema = GetAttribute(source, "schema", null);
        }
        ...
        protected override void FillXmlElement(XmlElement node)
        {
            ...
            AddAttribute(node, "schema", this.Schema);
        }
