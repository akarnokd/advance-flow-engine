...
{
    /// <summary>
    /// Wire binds a concrete type and a parametric type which cannot be in subtype relation.
    /// </summary>
    public class ConcreteVsParametricTypeError : CompilationErrorBase, IHasBinding, IHasTypes
    {
        public const string TYPE_NAME = "concretevsparametrictypeerror";
        /// <summary>
        /// wire identifier
        /// </summary>
        ...
        /// Empty constructor
        /// </summary>
        public ConcreteVsParametricTypeError() : base() { }
        ...
        {
            return "Concrete vs Parametric type conflict on wire " + this.binding.Id + ": " + this.Left + " vs. " + this.Right;
        }
