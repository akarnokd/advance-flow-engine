...
namespace AdvanceAPIClient.Classes.Error
{
    ...
    /// </summary>
    public class MissingDestinationError : CompilationErrorBase, IHasBinding
    {
        public const string TYPE_NAME = "missingdestinationerror";
        /// <summary>
        /// wire identifier
        /// </summary>
        ...
        /// Empty constructor
        /// </summary>
        public MissingDestinationError() : base() { }
        ...
        {
            return "Wire " + this.binding.Id + " has missing destination block " + this.binding.DestinationBlock;
        }
