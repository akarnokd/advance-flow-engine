...
{
    /// <summary>
    /// Wire binds two concrete types where the left type does not extend or equals to the right type.
    /// </summary>
    public class IncompatibleTypesError : CompilationErrorBase, IHasBinding, IHasTypes
    {
        public const string TYPE_NAME = "incompatibletypeserror";
        /// <summary>
        /// wire identifier
        /// </summary>
        ...
        /// Empty constructor
        /// </summary>
        public IncompatibleTypesError() : base() { }
        ...
        {
            return "Incompatible types of wire " + this.binding.Id + ": " + this.Left + " vs. " + this.Right;
        }
