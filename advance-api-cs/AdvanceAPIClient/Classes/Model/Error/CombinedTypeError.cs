...
namespace AdvanceAPIClient.Classes.Error
{
    ...
    /// </summary>
    public class CombinedTypeError : CompilationErrorBase, IHasBinding, IHasTypes
    {
        public const string TYPE_NAME = "combinedtypeerror";
        /// <summary>
        /// wire identifier
        /// </summary>
        ...
        public CombinedTypeError(AdvanceBlockBind binding, AdvanceType left, AdvanceType right) 
    {
        ...
        {
            return "Combined type could not be created for wire " + this.binding.Id + ": " + this.Left + " vs. " + this.Right;
        }
