...
namespace AdvanceAPIClient.Classes.Error
{
    ...
    /// </summary>
    public class SourceToCompositeInputError : CompilationErrorBase, IHasBinding
    {
        public const string TYPE_NAME = "sourcetocompositeinputerror";
        /// <summary>
        /// wire identifier
        /// </summary>
        ...
        /// Empty constructor
        /// </summary>
        public SourceToCompositeInputError() : base() { }
