...
{
    /// <summary>
    /// Varargs parameter has no counts set in the block reference.
    /// </summary>
    public class UnsetVarargsError : CompilationErrorBase
    {
        public const string TYPE_NAME = "unsetvarargserror";
        /// <summary>
