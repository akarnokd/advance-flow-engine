...
namespace AdvanceAPIClient.Classes.Error
{
    ...
    /// </summary>
    public class TypeArgumentCountError : CompilationErrorBase, IHasBinding, IHasTypes
    {
        public const string TYPE_NAME = "typeargumentcounterror";
        /// <summary>
        /// wire identifier
        /// </summary>
        ...
        /// Empty constructor
        /// </summary>
        public TypeArgumentCountError() : base() { }
	...
	public TypeArgumentCountError(AdvanceBlockBind binding, AdvanceType left, AdvanceType right) 
    {
        ...
        {
            return "Type argument count mismatch  " + this.binding.Id + ": " + this.Left + " vs. " + this.Right;
        }
