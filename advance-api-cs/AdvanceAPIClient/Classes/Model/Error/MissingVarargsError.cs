...
{
    /// <summary>
    /// Referenced varargs parameter is missing.
    /// </summary>
    public class MissingVarargsError : CompilationErrorBase
    {
        public const string TYPE_NAME = "missingvarargserror";
        /// <summary>
        ...
        /// Empty constructor
        /// </summary>
        public MissingVarargsError() : base() { }
        ...
        {
            return "Block reference " + this.Id + " (" + this.Type + ") uses missing varargs input " + this.Input;
        }
